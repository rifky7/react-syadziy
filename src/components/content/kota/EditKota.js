...
class EditKota extends React.Component {
    constructor (props) {
        super(props)
        this.state = {
            provinsi:[],
    ...
    async submitHandler(){
        ...
        let result = await API.editkota(this.state.formdata.kode_kota, this.state.formdata.nama_kota, this.state.formdata.kode_provinsi)
    ...
    render(){
        return(
            <Modal isOpen={this.props.edit} className={this.props.className}>
                <ModalHeader>Edit Data Kota</ModalHeader>
                <ModalBody >
                <form class="form-group">
                    <div class ="form-group">
                        <label for="text">Kode Kota : </label>
                        <input type="text" class="form-control"
                        name="kode_kota" readOnly
                    ...
                    <label for="text">Nama Kota : </label>
                        <input type="text" class="form-control"
                        name="nama_kota"
                        value={this.state.formdata.nama_kota}
                        onChange={this.changeHandler} />
                    </div>
                    <div class ="form-group">
                        <label>Provinsi</label>
                        <select name="kode_provinsi" class="form-control" onChange={this.changeHandler} required >
                            <option value={this.state.formdata.kode_provinsi}>{this.state.formdata.nama_provinsi}</option>
